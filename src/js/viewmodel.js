...
function initializeEditor(content, blockDefs, thumbPathConverter, galleryUrl) {
  ...
  var viewModel = {
    ...
    logoPath: 'dist/img/mosaico33.png',
    logoUrl: '.',
    logoAlt: 'mosaico'
  };
  ...
  */
  ...
  viewModel.exportMetadata = function() {
    ...
    var hash = $("#mdHash").val();
    var template = $("#mdTemplate").val();
    var project = $("#mdProject").val();
    var dept = $("#mdDept").val();
    var author = $("#mdAuthor").val();
    var dateCreated = $("#mdDateCreated").val();
    var lastEdit = Date.now();
    var lastChanger = $("#mdLastChanger").val();
    var meta = '{"hash":"' + hash + '","template":"' + template + '","name":"' + project + '","dept":"' + dept + '","author":"' + author + '","dateCreated":"' + dateCreated + '","lastEdit":"' + lastEdit + '","lastChanger":"' + lastChanger + '","templateversion":"1.0.5","editorversion":"0.14.0"}';
    return meta;
  };
